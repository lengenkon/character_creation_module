...
def attack(char_name: str, char_class: str) -> str:
    """Вычисляет урон при атаке и выводит сообщение."""
...
def defence(char_name: str, char_class: str) -> str:
    """Вычислает сколько урона блокировал и выводит сообщение."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Выводит сообщение и количество очков от применеия суперсилы."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    ...
    Пользователь выбирает атаку,
    защиту или суперсилу.
    """
    if char_class == 'warrior':
        print(
...
def choice_char_class() -> str:
    """Выводит сообщение для выбора персонажа.
    Записывает выбор от пользователя в
    переменную char_class и
    возвращает ее.
    """
    approve_choice: str = ''
    char_class: str = ''
